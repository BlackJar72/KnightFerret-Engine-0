...
public class Collision {
     ...
     * @return 
     */
    public static boolean imageOverlap(BufferedImage a, int ax, int ay, 
        ...
        if(ax < bx) {
            ...
            if(ay < by) {
                ...
                for(int i = 0; i < rx; i++) {
                    for(int j = 0; j < ry; j++) {
                        if(pixelOverlap(a.getRGB(i + offx, j + offy), 
                                b.getRGB(i, j))) {
                            return true;
                        }
                    }
                ...
                for(int i = 0; i < rx; i++) {
                    for(int j = 0; j < ry; j++) {
                        if(pixelOverlap(a.getRGB(i + offx, j), 
                                b.getRGB(i, j + offy))) {
                            return true;
                        }
                    }
            ...
            if(ay < by) {
                ...
                for(int i = 0; i < rx; i++) {
                    for(int j = 0; j < ry; j++) {
                        if(pixelOverlap(b.getRGB(i + offx, j), 
                                a.getRGB(i, j + offy))) {
                            return true;
                        }
                    }
                ...
                for(int i = 0; i < rx; i++) {
                    for(int j = 0; j < ry; j++) {
                        if(pixelOverlap(b.getRGB(i + offx, j + offy), 
                                a.getRGB(i, j))) {
                            return true;
                        }
                    }
